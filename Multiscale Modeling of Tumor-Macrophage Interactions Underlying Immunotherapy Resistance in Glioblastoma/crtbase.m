...
% in a chromosome.
%This function creates a vector containing the base pairs of loci in the chromosome.
%
...
%     A scalar or vector containing the lengths of alleles. Sum(Lind) represents the length of the corresponding chromosome.
%
%		Base	- A scalar or vector containing the base of
%		    	  the loci contained in the Alleles.
%     A scalar or vector containing the base pairs of loci in alleles.
%
% Output Parameters:
%
%		BaseVec	- A vector whose elements correspond to the base
%		    	  of the loci of the associated chromosome structure.
%                 A vector whose elements correspond to the base pairs of loci in genes related to chromosome structure.
%
